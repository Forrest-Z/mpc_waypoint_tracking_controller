...
#ifndef MPC_WAYPOINT_TRACKING_CONTROLLER_ROS_H
#define MPC_WAYPOINT_TRACKING_CONTROLLER_ROS_H
...
#include <mpc_waypoint_tracking_controller/mpc_waypoint_tracking_controller.h>
#include <mpc_waypoint_tracking_controller/MPCWayPointTrackerROSConfig.h>
...
namespace mpc_waypoint_tracking_controller {
    ...
    class MPCWayPointTrackerROS : public nav_core::BaseLocalPlanner {
        public:
            MPCWayPointTrackerROS();
            ~MPCWayPointTrackerROS();
            MPCWayPointTrackerROS(std::string name, 
                           tf2_ros::Buffer* tf,
        ...
        private:
            ...
            dynamic_reconfigure::Server<MPCWayPointTrackerROSConfig> *dsrv_;
            bool initialized_; // < @Flags
            ...
            void reconfigureCB(MPCWayPointTrackerROSConfig &config, uint32_t level);
...
#endif /* MPC_WAYPOINT_TRACKING_CONTROLLER_ROS_H */
